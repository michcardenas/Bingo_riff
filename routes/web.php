...
Route::post('/admin/reservas/store', [BingoController::class, 'store'])
    ...
    Route::get('/admin/reservas/{bingoId}/comprobantes-llave', [BingoAdminController::class, 'comprobantesLlave'])
    ->name('bingos.reservas.comprobantes-llave');
    Route::get('/admin/comprobantes-llave', [BingoAdminController::class, 'comprobantesLlaveGeneral'])
    ->name('admin.comprobantes-llave-general');
