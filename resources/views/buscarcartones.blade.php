    ...
    <header class="header">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo-container">
                <img src="{{ asset('images/RiffyLogo.png') }}" alt="RIFFY Bingo">
            </div>
            <!-- Enlaces -->
            <div>
                <a href="{{ route('cartones.index') }}" class="nav-link d-inline-block">Buscar mi cartón</a>
                <a href="{{ route('whatsapp.grupo') }}" class="nav-link d-inline-block">Grupo Whatsapp</a>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="help-container">
                ...
                <a href="#" class="video-link">video 2 aquí</a>
            </div>
        </div>
    </div>
