...
<div class="bg-black border border-white p-6 rounded-lg">
    <h2 class="text-2xl font-bold text-center mb-6">{{ __('Crear Cuenta') }}</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-white">{{ __('Nombre') }}</label>
        ...
        <div class="flex items-center justify-between mt-6">
            <a href="{{ route('login') }}" class="text-sm text-green-500 hover:text-[#00bf63] transition-all duration-300 group">
